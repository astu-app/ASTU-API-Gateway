...
class UserGroupsApi(private val client: HttpClient, private val baseUrl: String) {
     ...
     */
    suspend fun getUsergroupCreateContent(principalId: String): HttpResponseContent {
     ...
     */
    suspend fun createUsergroup(createUserGroupDto: CreateUserGroupDto, principalId: String): HttpResponseContent {
     ...
     */
    suspend fun getDetails(userGroupId: String, principalId: String): HttpResponseContent {
     ...
     */
    suspend fun getUsergroupUpdateContent(userGroupId: String, principalId: String): HttpResponseContent {
     ...
     */
    suspend fun updateUsergroup(updateUserGroupDto: UpdateUserGroupDto, principalId: String): HttpResponseContent {
     ...
     */
    suspend fun deleteUsergroup(userGroupId: String, principalId: String): HttpResponseContent {
        ...
        return when (response.status) {
            ...
            HttpStatusCode.BadRequest -> HttpResponseContent(response.body<ErrorCode>(), response.status)
            HttpStatusCode.Unauthorized -> HttpResponseContent(null, response.status)
            HttpStatusCode.Forbidden -> HttpResponseContent(null, response.status)
            HttpStatusCode.NotFound -> HttpResponseContent(response.body<ErrorCode>(), response.status)
            HttpStatusCode.InternalServerError -> HttpResponseContent(null, response.status)
            else -> HttpResponseContent(null, response.status)
        }
